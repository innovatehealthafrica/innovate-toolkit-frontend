...
export default function Benefit() {
  return (
    <section className="bg-white p-12 sm:px-12 sm:pt-12 sm:pb-8 h-auto sm:h-[350px] mt-[650px] sm:mt-60">
      <div className="flex flex-col md:flex-row justify-center items-center max-w-screen-2xl gap-9 mx-auto">
        <div>
          <h1 className="text-wrap text-left text-black font-bold">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex items-center justify-center gap-2">
            <CircleCheck color="#e0ac54" size={24} />
            <div>
